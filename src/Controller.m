classdef Controller < handle
  ...
  properties
    ...
    ampFactorIncreaseButton
    ampFactorDecreaseButton
  ...
  methods (Access = protected)
    ...
    function setup(obj)
      ...
      obj.timeSlider = uicontrol(obj.fig,...
        'Style','slider',...
        'Units','normalized',...
        'Position',[0.225 0.25 0.515 0.025],...
        'Callback',@obj.timeSliderChangedCallback...
      );
    
    
      % Picking tab
      uiPanelLeft = uitabgroup(obj.fig,'Position',[0.0075 0.01 0.18 0.98]);
      ...
      obj.channelTypePopup = uicontrol(uiPickingTab,...
        'Style','popupmenu',...
        'Units','normalized',...
        'Position',[0.25 0.5125 0.45 0.05],...
        'String',{'EHZ','EHN','EHE'},...
      ...
      obj.ampFactorDecreaseButton = uicontrol(uiPickingTab,...
        'Style','pushbutton',...
        'Units','normalized',...
        'Position',[0.7 0.07 0.275 0.04],...
        'String','Amp 10%-',...
        'Callback',@obj.onAmpDecrease...
      );
      obj.ampFactorIncreaseButton = uicontrol(uiPickingTab,...
        'Style','pushbutton',...
        'Units','normalized',...
        'Position',[0.7 0.12 0.275 0.04],...
        'String','Amp 15%+',...
        'Callback',@obj.onAmpIncrease...
      );
  ...
  methods (Access = private)
    ...
    function onAmpDecrease(obj,~,~)

      af = obj.miniSeedData.getAmpFactor();
      obj.miniSeedData.setAmpFactor(af*0.9);
      obj.miniSeedData.triggerUpdate();

    end

    function onAmpIncrease(obj,~,~)

      af = obj.miniSeedData.getAmpFactor();
      obj.miniSeedData.setAmpFactor(af*1.15);
      obj.miniSeedData.triggerUpdate();
